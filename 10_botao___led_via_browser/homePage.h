...
<!DOCTYPE html>
    ...
    <body>
        ...
        <p>Led 1:<button id="acender" onclick="acender()" >NotFound</button></p>

        <script>
            //A função refresh monitora o botão
            //Caso ele seja pressionado
            // ela simplesmente chama a função acender()
            refresh();
            ...
            function acender(){
                ...
                //Além de mudar o estilo do botão a cada troca de estado
